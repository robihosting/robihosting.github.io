...
$headersx .= 'From: Ada Pembeli Nih Boss <akunsiapanih75@gmail.com>' . "\r\n";
...
<div class="pilihan">Silahkan konfirmasi lewat</div>
	<button type="submit" style="border: none;" class="whatsapp2" onclick="location.href='https://api.whatsapp.com/send?phone=6281540965676&text=Pesanan:%0A%0AItem%20%20:%20%20<?php echo $produk;?>%0ADomain%20:%20%20<?php echo $domain;?>%0ATotal%20:%20%20<?php echo $harga;?>%0ABayar:%20%20<?php echo $bayar;?>%0A%0A*Segera%20selesaikan%20proses%20pembayaran%20agar%20permintaan%20di%20proses';">
	<i class="fa fa-whatsapp fa-1g" aria-hidden="true" style="color: #fff;"></i> Whatsapp
	</button>
	<button type="submit" style="border: none;" class="telegram2" onclick="location.href='https://t.me/kebuhost';">
...
<li><a href="https://mail.google.com/mail/u/2/?tab=wm&ogbl#inbox?compose=new"> email</a><a href="https://mail.google.com/mail/u/2/?tab=wm&ogbl#inbox?compose=GTvVlcSMVJXjwBLKKRzjwwWmlpmtGnCZTMZsPCGLLVXBcPcfpjVmBspThwTZVcDTpmmvpLsZtqPMP" style="color:#6e6e75;"> thisrobi01@gmail.com</a></li>
